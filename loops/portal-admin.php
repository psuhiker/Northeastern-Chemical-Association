										...
										<thead>
											...
											<?php foreach( $postsPending as $post ) {
												...
												<tr class="member item">
													...
													<td data-label="Get User's Account Creation Link">
														<a href="" data-toggle="modal" data-target="#linkModal<?php the_field('last_name'); ?><?php the_field('state'); ?>">
															<span class="glyphicon glyphicon-link" aria-hidden="true"></span>
														</a>
														<div class="modal fade" tabindex="-1" role="dialog" id="linkModal<?php the_field('last_name'); ?><?php the_field('state'); ?>">
														    <div class="modal-dialog" role="document">
														        <div class="modal-content modal-lg">
														            <div class="modal-header">
														                ...
														                <h4 class="modal-title"><?php the_field('first_name'); ?> <?php the_field('last_name'); ?>'s Account Creation Link</h4>
														            </div>
														            <div class="modal-body lg-padding--top">
														                <p>
																			<?php echo site_url(); ?>/membership/account/create/?trackingid=23FG567&firstName=<?php the_field('first_name'); ?>&lastName=<?php the_field('last_name'); ?>&email=<?php the_field('email_address'); ?>&company=<?php the_field('company'); ?>&phone=<?php the_field('phone'); ?>&address_one=<?php the_field('address_one'); ?>&address_two=<?php the_field('address_two'); ?>&city=<?php the_field('city'); ?>&state=<?php the_field('state'); ?>&zip=<?php the_field('zip'); ?>
																		</p>
														            </div>
														        </div>
														    </div>
